...
DefinitionBlock ("", "SSDT", 2, "HP14AC", "Battery", 0x00000000) {
#endif

    External (_SB.PCI0.LPCB.H_EC.XTIF, MethodObj)
    External (_SB.PCI0.LPCB.H_EC.XTST, MethodObj)
    External (_SB.PCI0.LPCB.H_EC.XTLB, MethodObj)
    External (_SB.PCI0.LPCB.H_EC.XBTI, MethodObj)
    External (_SB.PCI0.LPCB.H_EC.XQ09, MethodObj)
    External (_SB.PCI0.LPCB.H_EC.XQ10, MethodObj)
    External (_SB.PCI0.LPCB.H_EC.XQ11, MethodObj)
    ...
    */
    ...
    Scope (_SB.PCI0.LPCB.H_EC) {
        ...
        Method (BTIF, 1, Serialized) {
            ...
            Else { Return (\_SB.PCI0.LPCB.H_EC.XTIF ()) }
        }
        ...
        Method (BTST, 2, Serialized) {
            ...
            Else { Return (\_SB.PCI0.LPCB.H_EC.XTST ()) }
        }
